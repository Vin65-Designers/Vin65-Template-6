...
<cfset templateVariation="templateDark">
...
/* Elements */
body { background: url("../images/#templateVariation#/background.jpg") top left repeat; }

##background { position: relative; width: 1000px; min-height: 660px; margin: 0 auto; background: url("../images/#templateVariation#/background-main.jpg") top center no-repeat; }
##background-footer { position: relative; margin: 0 auto; height: 250px; background: url("../images/#templateVariation#/footer-bg.jpg") top center repeat; }
...
##topMenu { position: relative; float: right; width: 645px; height: 32px; margin: 85px 0 30px 0; border-bottom: 1px solid ##a2b988; text-transform:uppercase; z-index: 1100; }
	...
	##topMenu ul li a.hover { color: ##fff; background-color: #menuhovercolor#; text-decoration: none; }
		...
		##topMenu li:hover ul, ##layTopMenu li.over ul { display: block; background-color: #dropdowncolor#; }
			...
			##topMenu li a.v65-selected { color: #menutextcolor#; font-weight: bold; }
	
##contentWrapper { overflow: hidden; }
##pageContentWrapper { overflow: hidden; background: url("../images/#templateVariation#/content-bg.jpg") top center repeat; border: 5px solid ##FFF; margin: 0 0 20px 0; }
	##homepageContent { float:left; position: relative; padding: 20px; width: 480px; height: 360px; background: url("../images/#templateVariation#/homepage-content-bg.jpg") top center no-repeat ; overflow: hidden; }
